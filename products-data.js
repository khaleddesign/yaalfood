...
const PRODUCTS = [
  ...
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: '4 Fromages', desc: 'Tomate, fromage, chèvre, mozzarella, roquefort, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: '4 Fromages Blanche', desc: 'Crème fraîche, fromage, chèvre, mozzarella, roquefort, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Chèvre Miel', desc: 'Crème fraîche, fromage, chèvre, miel', single: 8.50 },
  ...
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Viande Hachée', desc: 'Tomate, fromage, viande hachée, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Poulet', desc: 'Tomate, crème fraîche, fromage, poulet, olive', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Merguez', desc: 'Tomate, fromage, merguez, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Chorizo', desc: 'Tomate, fromage, chorizo, poivron, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Kebab', desc: 'Tomate, fromage, kebab, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Jambon / Poulet', desc: 'Tomate, fromage, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Jambon Dinde', desc: 'Tomate, fromage, jambon dinde, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Napolitaine', desc: 'Tomate, fromage, anchois, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Saumon', desc: 'Tomate, fromage, saumon, olive, origan', single: 9.90 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Thon', desc: 'Tomate, fromage, thon, olive, origan', single: 8.50 },
  { cat: 'pizza', sub: 'classique', img: 'prod-pizza.png', name: 'Fruits de Mer', desc: 'Tomate, fromage, fruits de mer, olive, origan', single: 9.90 },

  /* ---- Pizzas Nouveautés ---- */
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: 'Tartiflette', desc: 'Crème fraîche, fromage, reblochon, pommes de terre, oignons rouges, veau fumé', single: 9.90, tag: 'Nouveau' },
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: 'La Boisée', desc: 'Crème fraîche, fromage, escalope, poulet, poivrons, sauce, gruyère', single: 9.90, tag: 'Nouveau' },
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: 'Chicago', desc: 'Crème fraîche, fromage, œuf, viande hachée, jambon dinde, cheddar', single: 9.90, tag: 'Nouveau' },
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: "L'Indienne", desc: 'Crème fraîche, fromage, poulet épicé, poivrons, sauce curry', single: 9.90, tag: 'Nouveau' },
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: 'Buffalo', desc: 'Sauce barbecue, fromage, sauce tomate, viande hachée, poivrons, oignons', single: 9.90, tag: 'Nouveau' },
  { cat: 'pizza', sub: 'nouveaute', img: 'prod-pizza.png', name: 'Campagnarde', desc: 'Crème fraîche, jambon, champignons, pommes de terre, boursin', single: 10.90, tag: 'Nouveau' },
  ...
  /* ---- Plats & Pâtes ---- */
  { cat: 'plats', img: null, name: 'Assiette Kebab', desc: 'Crudités, viande kebab, riz, frites', single: 12.00 },
  { cat: 'plats', img: null, name: 'Assiette Chicken', desc: 'Crudités, chicken au choix, riz, frites', single: 12.00 },
  { cat: 'plats', img: null, name: 'Assiette Berliner', desc: 'Crudités, viande kebab, légumes grillés, riz, frites', single: 13.50 },
  { cat: 'plats', img: null, name: 'Assiette Mixte', desc: 'Crudités, 2 viandes, riz, frites', single: 13.50 },
  { cat: 'plats', img: null, name: 'Pâtes Forestière', desc: 'Pâtes fraîches, sauce forestière', single: 7.00 },
  { cat: 'plats', img: null, name: 'Pâtes Bolognaise', desc: 'Pâtes fraîches, sauce bolognaise', single: 7.00 },
  { cat: 'plats', img: null, name: 'Pâtes Carbonara', desc: 'Pâtes fraîches, sauce carbonara', single: 7.00 },
  { cat: 'plats', img: null, name: 'Croustry Tenders', desc: 'Tenders croustillants, frites', single: 10.00 },
  { cat: 'plats', img: null, name: 'Croustry Curry', desc: 'Tenders croustillants sauce curry, frites', single: 10.00 },
